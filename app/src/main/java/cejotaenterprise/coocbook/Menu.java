package cejotaenterprise.coocbook;
...
public class Menu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageEntradas = (ImageButton)view.findViewById(R.id.imageEntradas);
        imageCarnes = (ImageButton)view.findViewById(R.id.imageCarnes);
        imageGuarniciones = (ImageButton)view.findViewById(R.id.imageGuarniciones);
        imageEnsaladas = (ImageButton)view.findViewById(R.id.imageEnsaladas);
        imagePastas = (ImageButton)view.findViewById(R.id.imagePastas);
        imageDesayunos = (ImageButton)view.findViewById(R.id.imageDesayunos);
        imageSopas = (ImageButton)view.findViewById(R.id.imageSopas);
        imagePescados = (ImageButton)view.findViewById(R.id.imagePescados);
        imagePostres = (ImageButton)view.findViewById(R.id.imagePostres);
